        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="ml-4 md:w-1/2">
                            ...
                            <div class="flex justify-around items-center">
                                <div>
                                    ...
                                    text-gray-900">{{ number_format($product->price) }}</span><span class="text-sm text-gray-700">円(税込)</span>
                                </div>
                    ...
                    <div class="mb-4 text-center">この商品を販売しているショップ
                    <div class="mb-4 text-center">{{ $product->shop->name }}</div>
                    <div class="mb-4 text-center">
                        @if ($product->shop->filename !== null)
                        {{-- <img class="mx-auto w-40 h-40 object-cover rounded-full" src="{{ asset('storage/shop/') . $product->shop->filename )}}"> --}}
                        @else
                            <img src="">
                        @endif
                    </div>
                    <div class="mb-4 text-center">
                        ...
                        class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none
                        hover:bg-gray-500 rounded">ショップの詳細を見る</button>
                    </div>
                    </div>
                </div>
            </div>
